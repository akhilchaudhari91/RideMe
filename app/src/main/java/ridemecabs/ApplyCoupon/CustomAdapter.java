...
public class CustomAdapter extends BaseAdapter {
	 ...
	 * @param data
	 */
	public CustomAdapter(Context context, int resource, ArrayList<Coupon> data) {
	...
	public View bindData(View view, int position) {
		...
		if(this.getCount()==0)
		{
			tv.setText("No coupons available");
		}

		// pull out the object
		Coupon item = this.data.get(position);

		tv.setText(item.CouponCode);
		
		tv = (TextView)view.findViewById(R.id.subTitle);
